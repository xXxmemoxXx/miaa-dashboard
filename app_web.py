...
# --- 3. MAPEOS ---
MAPEO_SCADA = {
    "P-002": {"GASTO_(l.p.s.)":"PZ_002_TRC_CAU_INS", "PRESION_(kg/cm2)":"PZ_002_TRC_PRES_INS", "VOLTAJE_L1":"PZ_002_TRC_VOL_L1_L2", "VOLTAJE_L2":"PZ_002_TRC_VOL_L2_L3", "VOLTAJE_L3":"PZ_002_TRC_VOL_L1_L3", "AMP_L1":"PZ_002_TRC_CORR_L1", "AMP_L2":"PZ_002_TRC_CORR_L2", "AMP_L3":"PZ_002_TRC_CORR_L3", "LONGITUD_DE_COLUMNA":"PZ_002_TRC_LONG_COLUM", "SUMERGENCIA":"PZ_002_TRC_SUMERG", "NIVEL_DINAMICO":"PZ_002_TRC_NIV_EST"},
    "P-003": {"GASTO_(l.p.s.)":"PZ_003_CAU_INS", "PRESION_(kg/cm2)":"PZ_003_PRES_INS", "VOLTAJE_L1":"PZ_003_VOL_L1_L2", "VOLTAJE_L2":"PZ_003_VOL_L2_L3", "VOLTAJE_L3":"PZ_003_VOL_L1_L3", "AMP_L1":"PZ_003_CORR_L1", "AMP_L2":"PZ_003_CORR_L2", "AMP_L3":"PZ_003_CORR_L3", "LONGITUD_DE_COLUMNA":"PZ_003_LONG_COLUM", "SUMERGENCIA":"PZ_003_SUMERG", "NIVEL_DINAMICO":"PZ_003_NIV_EST"},
    "P-004": {"GASTO_(l.p.s.)":"PZ_004_CAU_INS", "PRESION_(kg/cm2)":"PZ_004_PRES_INS", "VOLTAJE_L1":"PZ_004_VOL_L1_L2", "VOLTAJE_L2":"PZ_004_VOL_L2_L3", "VOLTAJE_L3":"PZ_004_VOL_L1_L3", "AMP_L1":"PZ_004_CORR_L1", "AMP_L2":"PZ_004_CORR_L2", "AMP_L3":"PZ_004_CORR_L3", "LONGITUD_DE_COLUMNA":"PZ_004_LONG_COLUM", "SUMERGENCIA":"PZ_004_SUMERG", "NIVEL_DINAMICO":"PZ_004_NIV_EST"},
    "P-005A": {"GASTO_(l.p.s.)":"PZ_RP_005_TRHDAS_CAU_INS", "PRESION_(kg/cm2)":"PZ_RP_005_TRHDAS_PRES_INS", "VOLTAJE_L1":"PZ_RP_005_TRHDAS_VOL_L1_L2", "VOLTAJE_L2":"PZ_RP_005_TRHDAS_VOL_L2_L3", "VOLTAJE_L3":"PZ_RP_005_TRHDAS_VOL_L1_L3", "AMP_L1":"PZ_RP_005_TRHDAS_CORR_L1", "AMP_L2":"PZ_RP_005_TRHDAS_CORR_L2", "AMP_L3":"PZ_RP_005_TRHDAS_CORR_L3", "LONGITUD_DE_COLUMNA":"PZ_RP_005_TRHDAS_LONG_COLUM", "SUMERGENCIA":"PZ_RP_005_TRHDAS_SUMERG", "NIVEL_DINAMICO":"PZ_RP_005_TRHDAS_NIV_EST"}
}
...
# --- 5. INTERFAZ CON PESTAÑAS ---

tab_monitor, tab_postgres = st.tabs(["🚀 Monitor de Sincronización", "🔍 Visor Postgres"])

with tab_monitor:
    st.header("Control de Cargas Automáticas")
...
with tab_postgres:
    st.header("Datos actuales en public.\"Pozos\"")
    if st.button("🔄 Refrescar Tabla Postgres"):
        try:
            p_pg = urllib.parse.quote_plus(DB_POSTGRES['pass'])
            eng_pg = create_engine(f"postgresql+psycopg2://{DB_POSTGRES['user']}:{p_pg}@{DB_POSTGRES['host']}:{DB_POSTGRES['port']}/{DB_POSTGRES['db']}")
            query = 'SELECT * FROM public."Pozos" ORDER BY "ID" ASC'
            df_pg = pd.read_sql(query, eng_pg)
            st.dataframe(df_pg, use_container_width=True)
            st.success(f"Mostrando {len(df_pg)} registros.")
        except Exception as e:
            st.error(f"No se pudo leer Postgres: {e}")
    else:
        st.info("Haz clic en el botón para cargar los datos de la base de datos.")
